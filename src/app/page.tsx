...
export default async function Home() {
  ...
  return (
    <main className="font-sans min-h-screen relative flex flex-col">
      <header className="absolute flex top-0 justify-center items-center text-2xl font-bold z-10 bg-[#F0F0F0]/80 w-full p-8">
        <h1 className="">みんなでつくる中国山地 百年会議 会員マップ</h1>
      </header>
      <div className="w-full min-h-screen relative">
        <MemberGeoGraph members={members} />
      </div>
      <footer className="absolute flex justify-center items-center bottom-0 z-10 bg-[#F0F0F0]/80 w-full p-4">
        <Link
